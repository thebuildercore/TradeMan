    ...
    switch (sortBy) {
      case "highest_yield":
        results = [...results].sort(
          (a, b) => parseFloat(b.dividendYield) - parseFloat(a.dividendYield),
        );
        break;
      case "lowest_min":
        results = [...results].sort(
          (a, b) => a.minimumInvestment - b.minimumInvestment,
        );
        break;
    ...
    <div className="bg-gray-50 min-h-screen pb-20">
      ...
      <div className="bg-gradient-to-br from-gray-900 to-primary-900 pt-16 pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            Explore Market{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary-400 to-emerald-300">
              Opportunities
            </span>
          </motion.h1>
          <motion.p
          ...
          >
            Discover verified local businesses seeking capital. Invest securely
            and build a portfolio of real-world assets yielding consistent
            dividends.
          </motion.p>
        </div>
      </div>
          ...
          <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-gray-100">
            {categories.slice(1).map((cat) => (
              <button
                ...
                onClick={() =>
                  setSelectedCategory(
                    cat.id === selectedCategory ? "all" : cat.id,
                  )
                }
            ...
            {filteredBusinesses.length > 0 ? (
                ...
                >
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 z-20 flex justify-between items-end">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-1 group-hover:text-primary-300 transition-colors drop-shadow-md">
                          {business.name}
                        </h3>
                        <div className="flex items-center text-gray-200 text-sm font-medium">
                          <MapPin size={14} className="mr-1" />{" "}
                          {business.location.split(",")[1] || business.location}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 flex-grow flex flex-col bg-white">
                    ...
                    >
                      ...
                      <ChevronRight
                        size={18}
                        className="ml-1 opacity-70 group-hover:opacity-100 group-hover:translate-x-1 transition-all"
                      />
                    </Link>
                  </div>
                </motion.div>
              ...
              >
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  We couldn't find any businesses matching your exact criteria.
