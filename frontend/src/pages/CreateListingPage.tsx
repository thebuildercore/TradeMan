...
const CreateListingPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    valuation: "",
    fundingGoal: "",
    percentToTokenize: 40,
    tokenPrice: "",
    totalTokens: 0,
    minimumInvestment: "",
    dividendYield: "",
    dividendFrequency: "quarterly",
    profitSharingPercentage: 45,
    nextDividendDate: "",
  });
  ...
  React.useEffect(() => {
    if (
      ...
      const valuationAmount = parseFloat(
        formData.valuation.replace(/[^0-9.]/g, ""),
      );
      const tokenizedValue =
        valuationAmount * (formData.percentToTokenize / 100);
      const totalTokens = Math.floor(
        tokenizedValue / parseFloat(formData.tokenPrice),
      );
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-500 mb-8 leading-relaxed">
            Please connect your Web3 wallet to securely list and tokenize your
            business on the Sepolia network.
          </p>
          <button
            onClick={connectWallet}
            className="w-full py-4 px-4 bg-gray-900 hover:bg-primary-600 text-white rounded-xl font-bold transition-all duration-300 shadow-lg transform hover:-translate-y-1"
          >
            Connect Wallet
          </button>
        </motion.div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-500 mb-8 leading-relaxed">
            Please switch your wallet to the Sepolia testnet to safely construct
            your tokenized listing.
          </p>
          <button
            onClick={switchToCorrectNetwork}
            className="w-full py-4 px-4 bg-red-600 hover:bg-red-700 text-white rounded-xl font-bold uppercase tracking-wider transition-all duration-300 shadow-lg shadow-red-600/30"
          >
            Switch to Sepolia
          </button>
        </motion.div>
    ...
    <div className="bg-gray-50 min-h-screen pb-20">
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-primary-900 pt-16 pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            <span className="bg-white/10 text-primary-200 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-4 inline-block backdrop-blur-md border border-white/10">
              Creator Studio
            </span>
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">
              Construct Offering
            </h1>
            <p className="text-primary-100 text-lg max-w-2xl mx-auto font-medium">
              Digitalize your equity, specify dividend parameters, and open
              doors to community ownership.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <>
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white p-6 md:p-8 mb-8">
                ...
                <div className="flex justify-between relative z-10">
                  {[1, 2, 3, 4].map((step) => (
                    <div key={step} className="flex flex-col items-center">
                      <motion.div
                        ...
                        className={`w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-sm shadow-md transition-colors duration-300 ${
                          step < currentStep
                            ...
                            : step === currentStep
                              ? "bg-gray-900 text-white border-2 border-primary-500"
                      ...
                      <span
                        className={`text-xs font-bold mt-3 uppercase tracking-wider ${step <= currentStep ? "text-gray-900" : "text-gray-400"}`}
                      >
                        {
                          ["Entity", "Financials", "Tokenomics", "Yield"][
                            step - 1
                          ]
                        }
                      </span>
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-medium transition-all"
                        ...
                        <div>
                          ...
                          <input
                            ...
                            placeholder="Café, SaaS, Retail"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-bold text-gray-700 mb-2">
                            HQ Region <span className="text-red-500">*</span>
                          </label>
                          <input
                            type="text"
                            name="location"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={4}
                          className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-medium"
                          placeholder="Explain the vision, operations, and catalyst for this raise..."
                        ></textarea>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex">
                          <input
                            ...
                            onChange={handleChange}
                            className="flex-grow px-4 py-3 bg-gray-50 border border-gray-200 rounded-l-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-medium"
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleCurrencyInput(e, "revenue")
                              }
                              className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-extrabold text-gray-900"
                              placeholder="0"
                            />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handleChange}
                              className="w-full pl-4 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-extrabold text-gray-900"
                              placeholder="0"
                            />
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleCurrencyInput(e, "valuation")
                              }
                              className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-extrabold text-gray-900"
                              placeholder="0"
                            />
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleCurrencyInput(e, "fundingGoal")
                              }
                              className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-extrabold text-gray-900"
                              placeholder="0"
                            />
                      ...
                      <div className="bg-primary-50 border border-primary-100 rounded-2xl p-5 flex gap-4 mt-8">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-primary-700">
                            Financials are encoded on-chain during issuance.
                            Fraudulent representations may result in
                            administrative delisting and slashing.
                          </p>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 mb-8">
                        <div className="flex justify-between items-center mb-6">
                          <label className="text-sm font-bold text-gray-900">
                            Equity Pool to Tokenize
                          </label>
                          <span className="text-2xl font-extrabold text-primary-600 px-3 py-1 bg-white rounded-lg shadow-sm">
                            {formData.percentToTokenize}%
                          </span>
                        </div>
                        <input
                          type="range"
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-6 pt-6 border-t border-gray-200">
                          <div className="flex-1 bg-white p-4 rounded-xl border border-gray-100 shadow-sm text-center">
                            ...
                            <p className="text-2xl font-extrabold text-gray-900">
                              {100 - formData.percentToTokenize}%
                            </p>
                          </div>
                          <div className="flex-1 bg-white p-4 rounded-xl border border-gray-100 shadow-sm text-center">
                            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleCurrencyInput(e, "tokenPrice")
                              }
                              className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-extrabold text-gray-900"
                              placeholder="10.00"
                            />
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            value={formData.totalTokens.toLocaleString()}
                            disabled
                            className="w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-xl font-extrabold text-gray-500 cursor-not-allowed"
                          />
                        </div>
                        <div className="md:col-span-2">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleCurrencyInput(e, "minimumInvestment")
                              }
                              className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-extrabold text-gray-900"
                              placeholder="100.00"
                            />
                  ...
                  {currentStep === 4 && (
                    ...
                    >
                      ...
                      <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                        <div className="flex justify-between items-center mb-6">
                          <label className="text-sm font-bold text-gray-900">
                            Profit Allocation to Pool
                          </label>
                          <span className="text-2xl font-extrabold text-emerald-600 px-3 py-1 bg-white rounded-lg shadow-sm">
                            {formData.profitSharingPercentage}%
                          </span>
                        </div>
                        <input
                          type="range"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-bold text-gray-600"
                        />
                      </div>
                    </motion.div>
                  )}
              ...
              <div className="flex justify-between items-center pt-8 mt-4 border-t border-gray-100">
                ...
                >
                  {currentStep === 4 ? "Review Offering" : "Continue"}{" "}
          ...
          >
            <div className="h-64 sm:h-80 relative overflow-hidden group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <h2 className="text-white text-4xl font-extrabold tracking-tight mb-2">
                  {formData.name || "Untitled Asset"}
                </h2>
                <div className="flex items-center text-gray-300 text-sm font-medium">
                  <span className="bg-primary-500/20 text-primary-300 px-2.5 py-1 rounded border border-primary-500/30 uppercase tracking-widest text-[10px] mr-3">
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-6">
                  <h3 className="text-xl font-extrabold text-gray-900 border-b border-gray-100 pb-3 flex items-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center bg-gray-50 px-4 py-3 rounded-xl">
                      ...
                      <span className="font-extrabold text-gray-900">
                        {formData.totalTokens.toLocaleString()} TKN
                      </span>
                    </div>
                    <div className="flex justify-between items-center border border-gray-100 px-4 py-3 rounded-xl">
                      <span className="text-sm font-bold text-gray-500">
                        Target Raise
                      </span>
              ...
              <div className="mt-10 p-6 bg-primary-50 border border-primary-100 rounded-2xl flex items-start gap-4">
                ...
                />
                <div>
                  <h4 className="font-extrabold text-primary-900 mb-1">
                    Blockchain Deployment Ready
                  </h4>
                  <p className="font-medium text-primary-700 text-sm">
                    Submitting will deploy a fresh ERC-20 token contract onto
                    the Sepolia testnet representing{" "}
                    {formData.percentToTokenize}% of{" "}
                    {formData.name || "your entity"}. Standard gas fees will
                    apply.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 border-t border-gray-100 p-6 flex justify-between items-center">
              <button
                ...
                className="px-6 py-3 rounded-xl font-bold flex items-center text-gray-600 bg-white border border-gray-200 hover:bg-gray-100 transition-colors shadow-sm"
              >
                <ArrowLeft size={18} className="mr-2" /> Modify
              </button>
              <button
                onClick={handleSubmit}
                className="px-8 py-3 bg-gray-900 hover:bg-primary-600 text-white rounded-xl font-bold shadow-xl shadow-gray-900/20 transform hover:-translate-y-0.5 transition-all flex items-center"
              >
